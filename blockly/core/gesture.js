 ...
 * @private
 */
Blockly.Gesture.prototype.updateFromEvent_ = function (e) { //0.
 ...
 * @private
 */
Blockly.Gesture.prototype.updateIsDragging_ = function () { //1.
    // Sanity check.
 ...
 * @package
 */
Blockly.Gesture.prototype.handleMove = function (e) { //-1.
    //it will first update the event
    this.updateFromEvent_(e);
    if (this.isDraggingWorkspace_) {
        this.workspaceDragger_.drag(this.currentDragDeltaXY_);
    }
    //and based on variables desides what to do next with them
    else if (this.isDraggingBlock_) {
        // for example drag a block
        this.blockDragger_.dragBlock(this.mostRecentEvent_,
            this.currentDragDeltaXY_);
    }
...
Blockly.Gesture.prototype.doFieldClick_ = function () {
    ...
    if (this.startField_.name == Blockly.Constants.NodeBlockly.CreateConFieldName) {
        this.startBlock_.createCons();
    }
    else {
