...
/**
 * Sets the disabled stack
 * @param {number} amount
 */
Blockly.Events.setDisabled = function (disabled) {
    Blockly.Events.disabled_ = disabled;
};

/**
* Gets the disabled stack
* @return {number} 
*/
Blockly.Events.getDisabled = function () {
    return Blockly.Events.disabled_;
};
