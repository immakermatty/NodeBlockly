...
Blockly.FieldDropdown.prototype.init = function () {
    ...
    this.arrow_.appendChild(document.createTextNode(this.sourceBlock_.RTL ?
        (this.sourceBlock_.RTLMod ? ' ' + Blockly.FieldDropdown.ARROW_CHAR : Blockly.FieldDropdown.ARROW_CHAR + ' ')
...
Blockly.FieldDropdown.prototype.showEditor_ = function () {
    Blockly.WidgetDiv.show(this, this.sourceBlock_.RTLMod ? false : this.sourceBlock_.RTL, null);
...
Blockly.FieldDropdown.prototype.createMenu_ = function () {
    ...
    menu.setRightToLeft(this.sourceBlock_.RTLMod ? false : this.sourceBlock_.RTL);
    ...
    for (var i = 0; i < options.length; i++) {
        ...
        menuItem.setRightToLeft(this.sourceBlock_.RTLMod ? false : this.sourceBlock_.RTL);
...
Blockly.FieldDropdown.prototype.positionMenu_ = function (menu) {
    ...
    if (this.sourceBlock_.RTLMod ? false : this.sourceBlock_.RTL) {
        Blockly.utils.uiMenu.adjustBBoxesForRTL(viewportBBox, anchorBBox, menuSize);
    }
    // Position the menu.
    Blockly.WidgetDiv.positionWithAnchor(viewportBBox, anchorBBox, menuSize,
        this.sourceBlock_.RTLMod ? false : this.sourceBlock_.RTL);
