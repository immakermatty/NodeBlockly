...
Blockly.Toolbox = function (workspace) {
     ...
     * @type {boolean}
     */
    this.RTL = workspace.RTLMod ? false : workspace.options.RTL;
...
Blockly.Toolbox.prototype.init = function () {
    ...
    this.HtmlDiv.setAttribute('dir', workspace.RTLMod ? false : workspace.RTL ? 'RTL' : 'LTR');
    ...
    this.config_['cssCollapsedFolderIcon'] =
        'blocklyTreeIconClosed' + (workspace.RTLMod ? 'Ltr' : workspace.RTL ? 'Rtl' : 'Ltr');
